...
df_1=pd.read_csv("churndata(1).csv") 
...
def predict():
    ...
    model = pickle.load(open("smotechurnmodel (1).sav", "rb"))
    ...
    df_2['tenure_class'] = pd.cut(df_2.tenure.astype(int), range(1, 80, 12), right=False, labels=labels)
    ...
    if single==1:
        o1 = "The Profiled Customer Is Likely To Churn!!"
        o2 = "Probability: {}".format(probablity*100)
    else:
        o1 = "The Profiled Customer Is Likely To Stay With The Service!!"
        o2 = "Probability: {}".format(probablity*100)
